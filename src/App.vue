<template>
  <div id="app" style="overflow: hidden;">
    <iv-visualisation title="Orbits" hotspotColumnHeight="25%">
      <template #hotspots>
        <iv-pane position="left" format="push">
            <iv-sidebar-content :showPagination="false" >
              <iv-sidebar-section title="Orbit Energy Regimes" icon="satellite">
                <p class="main-text">
              ...
              <iv-sidebar-section title="Velocity Boosts" theme="Gold">
        ...
        <iv-toggle-hotspot id="iv-fixed-hotspot-bottom" position="bottom" title="Effective Potential" style="background:none;" transparent>
            <EffPot ref="effPlot" style="overflow:hidden;"/>
        </iv-toggle-hotspot>

        <iv-fixed-hotspot id="iv-fixed-hotspot-topleft" position="topleft" title="Guidance" transparent>
        ...
        <iv-fixed-hotspot id="iv-fixed-hotspot-topright" position="topright" title="PlayackControls" transparent>
          ...
          <iv-button @click="elipticOrbit" style="margin-top:1vh; height:100%">Eliptical</iv-button>
          <iv-button @click="parabolicOrbit" style="margin-top:1vh; height:100%">Parabolic</iv-button>
          <iv-button @click="hyperbolicOrbit" style="margin-top:1vh; height:100%">Hyperbolic</iv-button>
        </iv-fixed-hotspot>
      ...
      <Orbits ref="orbits" @path-update="updatePlot" @position-update="updatePosition" @onresize="updateSize" v-bind:animationSpeed="animationSpeed"/>
...
export default {
  ...
  methods:{
    ...
    resetOrbit(){
      this.$refs.orbits.circularOrbit();
    },
    elipticOrbit(){
      this.$refs.orbits.elipticalOrbit();
    },
    parabolicOrbit(){
      this.$refs.orbits.parabolicOrbit();
    },
    hyperbolicOrbit(){
      this.$refs.orbits.hyperbolicOrbit();
    }
  },
  props:{
    animationSpeed: {
